...
export const sectionWhyIphone13Dummy = [
    {
        className: "-privacy",
        ...
        cta: [{ className: '-learnMore', content: 'Learn more about Apple and privacy >' }]
    },
    {
    ...
    },
    {
        ...
        cta: [{ className: '-learnMore', content: 'Learn more about Apple and the environment >' }]
    }
]